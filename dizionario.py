...
frame = Frame(root)
Label(root, text="Type word", font=("Helvetica 15 bold")).pack(side=LEFT)
word = Entry(frame, font=("Helvetica 15 bold"))
word.pack()
frame.pack(pady=10)

frame1 = Frame(root)
Label(frame1, text="", font=("Helvetica 10")).pack(side=LEFT)
meaning = Label(frame1, text="", font=("Helvetica 10"))
meaning.pack()
frame1.pack(pady=10)

frame2 = Frame(root)
Label(frame2, text="Synonym:-", font=("Helvetica 10"))
...
frame3 = Frame(root)
Label(frame3, text="Antonym:-", font=("Helvetica 10"))
